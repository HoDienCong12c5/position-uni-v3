...
var usePriceOrderingFromPositionForUI = function usePriceOrderingFromPositionForUI(position) {
  var price = react.useMemo(function () {
    if (!position) {
      ...
      var token0 = position === null || position === void 0 ? void 0 : position.amount0.currency;
      var token1 = position === null || position === void 0 ? void 0 : position.amount1.currency;
      ...
      if (stables.some(function (stable) {
        ...
        if (bases.some(function (base) {
          ...
          if (position.token0PriceUpper.lessThan(1)) {
            ...
            return {
              priceLower: position === null || position === void 0 ? void 0 : position.token0PriceLower,
              priceUpper: position === null || position === void 0 ? void 0 : position.token0PriceUpper,
              quote: token1,
              base: token0
            };
          }
  ...
  return {
    priceLower: price === null || price === void 0 ? void 0 : price.priceLower,
    priceUpper: price === null || price === void 0 ? void 0 : price.priceUpper,
    quote: price === null || price === void 0 ? void 0 : price.quote,
    base: price === null || price === void 0 ? void 0 : price.base
  };
...
var getToken = function getToken(address, chainId, listAllToken) {
  try {
    return Promise.resolve(listAllToken.find(function (item) {
...
var getPoolAddress = function getPoolAddress(factoryAddress, tokenA, tokenB, fee) {
  try {
    if (tokenA !== null && tokenA !== void 0 && tokenA.sortsBefore(tokenB)) {
      return Promise.resolve(v3Sdk.computePoolAddress({
      ...
      try {
        var _temp2 = function () {
          if (token0 && token1 && positionBasic && chainId && !isChangeToken) {
            return Promise.resolve(getAddressPool(token0, token1, positionBasic.fee, chainId)).then(function (_getAddressPool) {
...
function useV3PositionFees(pool, tokenId, web3, chainId) {
  ...
  var amountTokenPair = react.useMemo(function () {
    if ((amountNew === null || amountNew === void 0 ? void 0 : amountNew.length) > 0 && pool) {
      var _amountNew$, _amountNew$2;
      return [CurrencyAmount.fromRawAmount(pool.token0, (_amountNew$ = amountNew[0]) === null || _amountNew$ === void 0 ? void 0 : _amountNew$.toString()), CurrencyAmount.fromRawAmount(pool.token1, (_amountNew$2 = amountNew[1]) === null || _amountNew$2 === void 0 ? void 0 : _amountNew$2.toString())];
    }
...
var useFullPosition = function useFullPosition(idPool, chainId, listAllTokenSupport, web3) {
  var _useState = react.useState(true),
  ...
  var _usePool = usePool(tokenPre, tokenSub, slot0, positionBasic, isChangeToken),
    ...
    priceTokenPair = _usePool.priceTokenPair;
  var _usePosition = usePosition(poolHook, positionBasic),
    position = _usePosition.position;
  var pricesFromPositionHook = usePriceOrderingFromPositionForUI(position);
  var _useV3PositionFees = useV3PositionFees(poolHook, idPool, web3, chainId),
    feeValue0 = _useV3PositionFees[0],
    feeValue1 = _useV3PositionFees[1];
  var _useInverter = useInverter(pricesFromPositionHook, false),
    priceLower = _useInverter.priceLower,
    priceUpper = _useInverter.priceUpper,
    base = _useInverter.base,
    quote = _useInverter.quote;
  react.useEffect(function () {
  ...
  var symbol = react.useMemo(function () {
    if (tokenPre && tokenSub) {
      return {
        symbolPre: tokenPre === null || tokenPre === void 0 ? void 0 : tokenPre.symbol,
        symbolSub: tokenSub === null || tokenSub === void 0 ? void 0 : tokenSub.symbol
      };
    }
  }, [tokenPre, tokenSub]);
  var liquidity = react.useMemo(function () {
    if (position && ratioLiquidity >= -1) {
      var _position$amount0$toS, _position$amount1$toS;
      var ratioPre = ratioLiquidity;
      var ratioSub = 100 - ratioLiquidity;
      if (Number((_position$amount0$toS = position === null || position === void 0 ? void 0 : position.amount0.toSignificant(4)) != null ? _position$amount0$toS : 0) === 0 && Number((_position$amount1$toS = position === null || position === void 0 ? void 0 : position.amount1.toSignificant(4)) != null ? _position$amount1$toS : 0) === 0) {
        ratioSub = 0;
        ratioPre = 0;
      }
      return {
        liquidityPre: position === null || position === void 0 ? void 0 : position.amount0.toSignificant(4),
        ratioPre: ratioPre,
        liquiditySub: position === null || position === void 0 ? void 0 : position.amount1.toSignificant(4),
        ratioSub: ratioSub
      };
    }
    return null;
  }, [position, ratioLiquidity]);
  var ratioUSDC = useGetRatioUSDC(tokenPre, tokenSub, liquidity, position);
  react.useEffect(function () {
