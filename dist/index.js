...
var useInverter = function useInverter(pricesFromPosition, invert) {
  ...
  var inverter = react.useMemo(function () {
    if (pricesFromPosition) {
      var _pricesFromPosition$p, _pricesFromPosition$p2;
      return {
        priceUpper: !invert ? pricesFromPosition === null || pricesFromPosition === void 0 ? void 0 : (_pricesFromPosition$p = pricesFromPosition.priceLower) === null || _pricesFromPosition$p === void 0 ? void 0 : _pricesFromPosition$p.invert() : pricesFromPosition === null || pricesFromPosition === void 0 ? void 0 : pricesFromPosition.priceUpper,
        priceLower: !invert ? pricesFromPosition === null || pricesFromPosition === void 0 ? void 0 : (_pricesFromPosition$p2 = pricesFromPosition.priceUpper) === null || _pricesFromPosition$p2 === void 0 ? void 0 : _pricesFromPosition$p2.invert() : pricesFromPosition === null || pricesFromPosition === void 0 ? void 0 : pricesFromPosition.priceLower,
        quote: invert ? pricesFromPosition === null || pricesFromPosition === void 0 ? void 0 : pricesFromPosition.base : pricesFromPosition === null || pricesFromPosition === void 0 ? void 0 : pricesFromPosition.quote,
        base: invert ? pricesFromPosition === null || pricesFromPosition === void 0 ? void 0 : pricesFromPosition.quote : pricesFromPosition === null || pricesFromPosition === void 0 ? void 0 : pricesFromPosition.base
      };
    }
    return null;
...
var usePool = function usePool(token0, token1, slot0, positionBasic, isChangeToken) {
  var poolHook = react.useMemo(function () {
    if (token0 && token1 && positionBasic && slot0 && !isChangeToken) {
      return new v3Sdk.Pool(token0, token1, positionBasic.fee, slot0.sqrtPriceX96, positionBasic.liquidity, slot0.tick);
    }
    return null;
...
var usePosition = function usePosition(pool, positionBasic) {
  var positionSDK = react.useMemo(function () {
    if (pool && pool && positionBasic !== null && positionBasic !== void 0 && positionBasic.liquidity && typeof (positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tickLower) === 'number' && typeof (positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tickUpper) === 'number') {
      return new v3Sdk.Position({
        pool: pool,
        liquidity: positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.liquidity,
        tickLower: positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tickLower,
        tickUpper: positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tickUpper
      });
    }
    return null;
  }, [pool, positionBasic]);
...
var NONFUNGIBLE_POSITION_MANAGER_ADDRESSES = _extends({}, constructSameAddressMap('0xC36442b4a4522E871399CD717aBDD847Ab11FE88', [SupportedChainId.OPTIMISM, SupportedChainId.OPTIMISM_GOERLI, SupportedChainId.ARBITRUM_ONE, SupportedChainId.ARBITRUM_RINKEBY, SupportedChainId.POLYGON_MUMBAI, SupportedChainId.POLYGON]), (_extends2 = {}, _extends2[SupportedChainId.CELO] = CELO_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES, _extends2[SupportedChainId.CELO_ALFAJORES] = CELO_NONFUNGIBLE_POSITION_MANAGER_ADDRESSES, _extends2));
var CHAIN_NETWORK_WITH_CHAIN_NAME = {
  ethereum: 1,
  bnb: 56,
  optimism: 10,
  polygon: 137,
...
})(SupportedChainId$1 || (SupportedChainId$1 = {}));
...
var MaxUint256 = /*#__PURE__*/jsbiUmd.BigInt('0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff');
...
var Decimal = /*#__PURE__*/toFormat_1(decimal);
var Big = /*#__PURE__*/toFormat_1(big);
var toSignificantRounding = (_toSignificantRoundin = {}, _toSignificantRoundin[Rounding.ROUND_DOWN] = Decimal.ROUND_DOWN, _toSignificantRoundin[Rounding.ROUND_HALF_UP] = Decimal.ROUND_HALF_UP, _toSignificantRoundin[Rounding.ROUND_UP] = Decimal.ROUND_UP, _toSignificantRoundin);
var toFixedRounding = (_toFixedRounding = {}, _toFixedRounding[Rounding.ROUND_DOWN] = 0, _toFixedRounding[Rounding.ROUND_HALF_UP] = 1, _toFixedRounding[Rounding.ROUND_UP] = 3, _toFixedRounding);
var Fraction = /*#__PURE__*/function () {
  function Fraction(numerator, denominator) {
    if (denominator === void 0) {
      denominator = jsbiUmd.BigInt(1);
    }

    this.numerator = jsbiUmd.BigInt(numerator);
    this.denominator = jsbiUmd.BigInt(denominator);
  }

  Fraction.tryParseFraction = function tryParseFraction(fractionish) {
    if (fractionish instanceof jsbiUmd || typeof fractionish === 'number' || typeof fractionish === 'string') return new Fraction(fractionish);
  ...
  _proto.add = function add(other) {
    ...
    if (jsbiUmd.equal(this.denominator, otherParsed.denominator)) {
      return new Fraction(jsbiUmd.add(this.numerator, otherParsed.numerator), this.denominator);
    }

    return new Fraction(jsbiUmd.add(jsbiUmd.multiply(this.numerator, otherParsed.denominator), jsbiUmd.multiply(otherParsed.numerator, this.denominator)), jsbiUmd.multiply(this.denominator, otherParsed.denominator));
  };
  ...
  _proto.subtract = function subtract(other) {
    ...
    if (jsbiUmd.equal(this.denominator, otherParsed.denominator)) {
      return new Fraction(jsbiUmd.subtract(this.numerator, otherParsed.numerator), this.denominator);
    }

    return new Fraction(jsbiUmd.subtract(jsbiUmd.multiply(this.numerator, otherParsed.denominator), jsbiUmd.multiply(otherParsed.numerator, this.denominator)), jsbiUmd.multiply(this.denominator, otherParsed.denominator));
  };

  _proto.lessThan = function lessThan(other) {
    var otherParsed = Fraction.tryParseFraction(other);
    return jsbiUmd.lessThan(jsbiUmd.multiply(this.numerator, otherParsed.denominator), jsbiUmd.multiply(otherParsed.numerator, this.denominator));
  };

  _proto.equalTo = function equalTo(other) {
    var otherParsed = Fraction.tryParseFraction(other);
    return jsbiUmd.equal(jsbiUmd.multiply(this.numerator, otherParsed.denominator), jsbiUmd.multiply(otherParsed.numerator, this.denominator));
  };

  _proto.greaterThan = function greaterThan(other) {
    var otherParsed = Fraction.tryParseFraction(other);
    return jsbiUmd.greaterThan(jsbiUmd.multiply(this.numerator, otherParsed.denominator), jsbiUmd.multiply(otherParsed.numerator, this.denominator));
  };

  _proto.multiply = function multiply(other) {
    var otherParsed = Fraction.tryParseFraction(other);
    return new Fraction(jsbiUmd.multiply(this.numerator, otherParsed.numerator), jsbiUmd.multiply(this.denominator, otherParsed.denominator));
  };

  _proto.divide = function divide(other) {
    var otherParsed = Fraction.tryParseFraction(other);
    return new Fraction(jsbiUmd.multiply(this.numerator, otherParsed.denominator), jsbiUmd.multiply(this.denominator, otherParsed.numerator));
  };
  ...
  _createClass(Fraction, [{
    key: "quotient",
    get: function get() {
      return jsbiUmd.divide(this.numerator, this.denominator);
    } // remainder after floor division

  }, {
    key: "remainder",
    get: function get() {
      return new Fraction(jsbiUmd.remainder(this.numerator, this.denominator), this.denominator);
    }
  }, {
    key: "asFraction",
    get: function get() {
...
var Big$1 = /*#__PURE__*/toFormat_1(big);
var CurrencyAmount = /*#__PURE__*/function (_Fraction) {
  ...
  function CurrencyAmount(currency, numerator, denominator) {
    ...
    !jsbiUmd.lessThanOrEqual(_this.quotient, MaxUint256) ? process.env.NODE_ENV !== "production" ? invariant(false, 'AMOUNT') : invariant(false) : void 0;
    _this.currency = currency;
    _this.decimalScale = jsbiUmd.exponentiate(jsbiUmd.BigInt(10), jsbiUmd.BigInt(currency.decimals));
    return _this;
  }
  /**
...
var _extends2$1, _STABLECOIN_AMOUNT_OU;
...
var WETH9$1 = {};
var WRAPPED_NATIVE_CURRENCY = _extends({}, WETH9$1, (_extends2$1 = {}, _extends2$1[SupportedChainId.OPTIMISM] = new Token(SupportedChainId.OPTIMISM, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether'), _extends2$1[SupportedChainId.OPTIMISM_GOERLI] = new Token(SupportedChainId.OPTIMISM_GOERLI, '0x4200000000000000000000000000000000000006', 18, 'WETH', 'Wrapped Ether'), _extends2$1[SupportedChainId.ARBITRUM_ONE] = new Token(SupportedChainId.ARBITRUM_ONE, '0x82aF49447D8a07e3bd95BD0d56f35241523fBab1', 18, 'WETH', 'Wrapped Ether'), _extends2$1[SupportedChainId.ARBITRUM_RINKEBY] = new Token(SupportedChainId.ARBITRUM_RINKEBY, '0xB47e6A5f8b33b3F17603C83a0535A9dcD7E32681', 18, 'WETH', 'Wrapped Ether'), _extends2$1[SupportedChainId.POLYGON] = new Token(SupportedChainId.POLYGON, '0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270', 18, 'WMATIC', 'Wrapped MATIC'), _extends2$1[SupportedChainId.POLYGON_MUMBAI] = new Token(SupportedChainId.POLYGON_MUMBAI, '0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889', 18, 'WMATIC', 'Wrapped MATIC'), _extends2$1[SupportedChainId.CELO] = new Token(SupportedChainId.CELO, '0x471ece3750da237f93b8e339c536989b8978a438', 18, 'CELO', 'Celo native asset'), _extends2$1[SupportedChainId.CELO_ALFAJORES] = new Token(SupportedChainId.CELO_ALFAJORES, '0xf194afdf50b03e69bd7d057c1aa9e10c9954e4c9', 18, 'CELO', 'Celo native asset'), _extends2$1));
var tokens = {
...
var STABLECOIN_AMOUNT_OUT = (_STABLECOIN_AMOUNT_OU = {}, _STABLECOIN_AMOUNT_OU[SupportedChainId.MAINNET] = CurrencyAmount.fromRawAmount(USDC_MAINNET, 100000000000), _STABLECOIN_AMOUNT_OU[SupportedChainId.ARBITRUM_ONE] = CurrencyAmount.fromRawAmount(USDC_ARBITRUM, 100000000000), _STABLECOIN_AMOUNT_OU[SupportedChainId.OPTIMISM] = CurrencyAmount.fromRawAmount(DAI_OPTIMISM, 100000000000000000000000), _STABLECOIN_AMOUNT_OU[SupportedChainId.POLYGON] = CurrencyAmount.fromRawAmount(USDC_POLYGON, 100000000000), _STABLECOIN_AMOUNT_OU[SupportedChainId.CELO] = CurrencyAmount.fromRawAmount(CUSD_CELO, 100000000000000000000000), _STABLECOIN_AMOUNT_OU);

var usePriceOrderingFromPositionForUI = function usePriceOrderingFromPositionForUI(position) {
  var price = react.useMemo(function () {
    if (!position) {
      ...
      if (stables.some(function (stable) {
        ...
        var bases = [].concat(Object.values(WRAPPED_NATIVE_CURRENCY), [WBTC]);
...
var getRatio = function getRatio(lower, current, upper) {
  try {
    ...
    var a = Number.parseFloat(lower.toSignificant(20));
    var b = Number.parseFloat(upper.toSignificant(20));
    var c = Number.parseFloat(current.toSignificant(20));
...
var getToken = function getToken(address, chainId, listAllToken) {
  var tokenTemp = listAllToken.find(function (item) {
    return item.address.toUpperCase() === address.toUpperCase();
  });
  if (!tokenTemp) {
    return null;
  }
  var tokenNew = new Token(Number(chainId), address, tokenTemp.decimals, tokenTemp.symbol, tokenTemp.name);
  return tokenNew;
};
...
var UtilWeb3 = /*#__PURE__*/function () {
  function UtilWeb3() {}
  UtilWeb3.createWeb3 = function createWeb3(rpc) {
    var web3 = new Web3();
    web3.setProvider(new Web3.providers.HttpProvider(rpc));
    return web3;
  };
  UtilWeb3.getBalanceOf = function getBalanceOf(address, contractAddress, web3) {
  ...
  UtilWeb3.getPoolID = function getPoolID(address, index, contractAddress, web3) {
    return new Promise(function (resolve, reject) {
      try {
        var ABI = [{
          inputs: [{
        ...
        var contract = new web3.eth.Contract(ABI, contractAddress);
        contract.methods.tokenOfOwnerByIndex(address, index).call(function (err, result) {
          if (err) {
...
var useListPoolByAddress = function useListPoolByAddress(chainId, address, web3, listChainSupport) {
  var _useState = react.useState([]),
    listPoolForAddress = _useState[0],
    setListPoolForAddress = _useState[1];
  var _useState2 = react.useState(-1),
    balanceOfUser = _useState2[0],
    setBalanceOfUser = _useState2[1];
  react.useEffect(function () {
    setBalanceOfUser(-1);
    setListPoolForAddress([]);
    if (chainId && address && web3) {
      if (listChainSupport.includes(Number(chainId))) {
        UtilWeb3.getBalanceOf(address, NONFUNGIBLE_POSITION_MANAGER_ADDRESSES[Number(chainId)], web3).then(function (numberPool) {
  ...
  react.useEffect(function () {
    if (balanceOfUser > 0 && chainId) {
      for (var i = 0; i < balanceOfUser; i++) {
        UtilWeb3.getPoolID(address, i, NONFUNGIBLE_POSITION_MANAGER_ADDRESSES[Number(chainId)], web3).then(function (poolId) {
          if (poolId > -1) {
            setListPoolForAddress(function (pre) {
              return [].concat(pre, [poolId.toString()]);
            });
          }
        });
      }
  ...
  var listPoolMemo = react.useMemo(function () {
    if (balanceOfUser >= 1 && balanceOfUser === (listPoolForAddress === null || listPoolForAddress === void 0 ? void 0 : listPoolForAddress.length)) {
      return {
...
var useGetRatioUSDC = function useGetRatioUSDC(token0, token1, liquidity, position) {
  var _useState = react.useState(true),
    isGetting = _useState[0],
    setIsGetting = _useState[1];
  var _useState2 = react.useState({}),
    priceAll = _useState2[0],
    setPriceAll = _useState2[1];
  react.useEffect(function () {
    setIsGetting(true);
    setPriceAll({});
    if (token0 && token1 && liquidity !== null && liquidity !== void 0 && liquidity.liquidityPre && position) {
      var symbol1 = token0.symbol;
      var symbol2 = token1.symbol;
      var getPriceTokenPre = function getPriceTokenPre() {
        try {
          return Promise.resolve(axios.get("https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&symbols=" + symbol1.toLowerCase()));
        } catch (e) {
          return Promise.reject(e);
        }
      };
      var getPriceTokenSub = function getPriceTokenSub() {
        try {
          return Promise.resolve(axios.get("https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&symbols=" + symbol2.toLowerCase()));
        } catch (e) {
          return Promise.reject(e);
        }
      };
      Promise.all([getPriceTokenPre(), getPriceTokenSub()]).then(function (rs) {
        var _rs$, _rs$2;
        var ob = {
          price1: (_rs$ = rs[0]) === null || _rs$ === void 0 ? void 0 : _rs$.data[0].current_price,
          price2: (_rs$2 = rs[1]) === null || _rs$2 === void 0 ? void 0 : _rs$2.data[0].current_price
        };
        setPriceAll(ob);
      });
    }
  }, [liquidity]);
  var liquidityByUSDC = react.useMemo(function () {
    if (priceAll && position) {
      var pricePre = priceAll.price1 * (position === null || position === void 0 ? void 0 : position.amount0.toSignificant(4));
      var priceSub = priceAll.price2 * (position === null || position === void 0 ? void 0 : position.amount1.toSignificant(4));
      setIsGetting(false);
  ...
  return {
    liquidityByUSDC: liquidityByUSDC,
    isGetting: isGetting
  };
};
...
var getPositionUniswapAddress$1 = function getPositionUniswapAddress(chainId) {
  return NONFUNGIBLE_POSITION_MANAGER_ADDRESSES[chainId];
};
var getPositions = function getPositions(contractAdress, tokenId, web3) {
  return new Promise(function (resolve, reject) {
    var abi = [{
      inputs: [{
        internalType: 'uint256',
    ...
    contract.methods.positions(tokenId).call(function (err, result) {
      if (err) {
        resolve(err);
      }
      resolve(result);
...
var getOwnerOf = function getOwnerOf(addressContract, tokenId, web3) {
  return new Promise(function (resolve, reject) {
    try {
      var minABI = [{
        inputs: [{
      ...
      var contract = new web3.eth.Contract(minABI, addressContract);
      contract.methods.ownerOf(tokenId).call(function (err, balance) {
        if (err) {
          resolve(0);
        }
        resolve(balance);
...
var getPositionFee = function getPositionFee(addressContract, tokenId, recipient, amount0, amount1, owner, web3) {
  return new Promise(function (resolve, reject) {
    try {
      var _temp2 = _catch(function () {
        ...
        var web3Provider = new ethers.ethers.providers.Web3Provider(web3.currentProvider);
        var contract = new ethers.ethers.Contract(addressContract, minABI, web3Provider);
        return Promise.resolve(contract.callStatic.collect({
          tokenId: tokenId,
          recipient: recipient,
          amount0Max: amount0,
          amount1Max: amount1
...
var usePositionBasic = function usePositionBasic(idPool, chainId, listAllTokenSupport, web3) {
  ...
  var _useState4 = react.useState(false),
    isChangeToken = _useState4[0],
    setIsChangeToken = _useState4[1];
  var _useState5 = react.useState(false),
    isNoData = _useState5[0],
    setIsNoData = _useState5[1];
  ...
  react.useEffect(function () {
    var getDataBasic = function getDataBasic() {
      try {
        getPositions(getPositionUniswapAddress$1(Number(chainId)), Number(idPool), web3).then(function (pos) {
          if (pos.liquidity && (listAllTokenSupport === null || listAllTokenSupport === void 0 ? void 0 : listAllTokenSupport.length) > 0) {
            setLoading(false);
            Promise.all([setTokenPre(getToken(pos.token0, chainId, listAllTokenSupport)), setTokenSub(getToken(pos.token1, chainId, listAllTokenSupport))]);
            Promise.all([setIsChangeToken(false), setPositionBasic(_extends({}, pos, {
              fee: Number(pos.fee),
              liquidity: ethers.BigNumber.from(pos.liquidity),
  ...
  react.useEffect(function () {
    if (idPool && web3 && chainId && (listAllTokenSupport === null || listAllTokenSupport === void 0 ? void 0 : listAllTokenSupport.length) > 0) {
      Promise.all([setTokenPre(null), setTokenSub(null), setPositionBasic(null), setIsChangeToken(true), setIsNoData(false)]).then(function () {
        return setLoading(true);
      });
    }
  }, [chainId, idPool, listAllTokenSupport]);
  var positionBasicMemo = react.useMemo(function () {
    if (!isNoData && tokenSub && tokenPre && positionBasic && !isChangeToken) {
      return {
        tokenSub: tokenSub,
        tokenPre: tokenPre,
        positionBasic: positionBasic,
        isChangeToken: isChangeToken,
        isNoData: isNoData,
        loading: loading
      };
    }
      ...
      try {
        if (!isChangeToken) {
          if (token0 && token1 && positionBasic && chainId) {
            getSlot0(getAddressPool(token0, token1, positionBasic.fee, chainId), web3).then(function (resSlot0) {
              if (resSlot0.sqrtPriceX96) {
                setSlot0(_extends({}, resSlot0, {
                  tick: Number(resSlot0.tick),
                  sqrtPriceX96: ethers.BigNumber.from(resSlot0.sqrtPriceX96)
                }));
              }
            });
          }
...
function useV3PositionFees(pool, tokenId, web3, chainId, asWETH) {
  var _useState = react.useState([]),
    amountNew = _useState[0],
    setAmountNew = _useState[1];
  var MAX_UINT128 = BigNumber.from(2).pow(128).sub(1);
  react.useEffect(function () {
    var getAmountPairToken = function getAmountPairToken() {
      try {
        var contractAddress = getPositionUniswapAddress(chainId);
        return Promise.resolve(getOwnerOf(contractAddress, tokenId, web3)).then(function (owner) {
          return Promise.resolve(getPositionFee(contractAddress, tokenId, owner, MAX_UINT128, MAX_UINT128, owner, web3).then(function (value) {
            setAmountNew(value);
          })).then(function () {});
        });
      } catch (e) {
  ...
  var PositionFeeSDK = react.useMemo(function () {
    if ((amountNew === null || amountNew === void 0 ? void 0 : amountNew.length) > 0 && pool) {
      var _amountNew$, _amountNew$2;
      return {
        feeValue0: CurrencyAmount.fromRawAmount(pool.token0, (_amountNew$ = amountNew[0]) === null || _amountNew$ === void 0 ? void 0 : _amountNew$.toString()),
        feeValue1: CurrencyAmount.fromRawAmount(pool.token1, (_amountNew$2 = amountNew[1]) === null || _amountNew$2 === void 0 ? void 0 : _amountNew$2.toString())
      };
    }
    return {
      feeValue0: null,
...
var useFullPosition = function useFullPosition(address, chainId, web3, listAllTokenSupport, listChainSupport) {
  var _useState = react.useState(0),
    indexPool = _useState[0],
    setIndexPool = _useState[1];
  var _useState2 = react.useState([]),
  ...
  var _useState4 = react.useState([]),
    listPoolState = _useState4[0],
    setListPoolState = _useState4[1];
  var listPoolOfAddress = useListPoolByAddress(chainId, address, web3, listChainSupport);
  react.useEffect(function () {
    var _listPoolOfAddress$li, _listPoolOfAddress$li2;
    if ((listPoolOfAddress === null || listPoolOfAddress === void 0 ? void 0 : (_listPoolOfAddress$li = listPoolOfAddress.listPoolId) === null || _listPoolOfAddress$li === void 0 ? void 0 : _listPoolOfAddress$li.length) > 0) {
      console.log({
        listPoolOfAddress: listPoolOfAddress
      });
      setListPoolState([].concat(listPoolState, [listPoolOfAddress === null || listPoolOfAddress === void 0 ? void 0 : listPoolOfAddress.listPoolId]));
    }
    if ((listPoolOfAddress === null || listPoolOfAddress === void 0 ? void 0 : (_listPoolOfAddress$li2 = listPoolOfAddress.listPoolId) === null || _listPoolOfAddress$li2 === void 0 ? void 0 : _listPoolOfAddress$li2.length) === 0 && listPoolOfAddress !== null && listPoolOfAddress !== void 0 && listPoolOfAddress.noData) {
      setTimeRadom();
    }
  }, [listPoolOfAddress]);
  var positionBasic = usePositionBasic(listPoolOfAddress === null || listPoolOfAddress === void 0 ? void 0 : listPoolOfAddress.listPoolId[indexPool], Number(chainId), listAllTokenSupport, web3);
  var slot0 = useSlot0(positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tokenPre, positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tokenSub, positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.positionBasic, chainId, web3, positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.isChangeToken);
  var _usePool = usePool(positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tokenPre, positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tokenSub, slot0, positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.positionBasic, positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.isChangeToken),
    poolHook = _usePool.poolHook;
  var _usePosition = usePosition(poolHook, positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.positionBasic),
    positionSDK = _usePosition.positionSDK;
  var pricesFromPositionHook = usePriceOrderingFromPositionForUI(positionSDK);
  var inverterToken = useInverter(pricesFromPositionHook, false);
  var _useV3PositionFees = useV3PositionFees(poolHook, listPoolOfAddress === null || listPoolOfAddress === void 0 ? void 0 : listPoolOfAddress.listPoolId[indexPool], web3, chainId),
    feeValue0 = _useV3PositionFees.feeValue0,
    feeValue1 = _useV3PositionFees.feeValue1;

  var unClaimFee = react.useMemo(function () {
    if (positionBasic !== null && positionBasic !== void 0 && positionBasic.tokenPre && positionBasic !== null && positionBasic !== void 0 && positionBasic.tokenSub && feeValue0 && feeValue1 && !(positionBasic !== null && positionBasic !== void 0 && positionBasic.isNoData)) {
      var a = formatCurrencyAmount(feeValue0, 4).toString().includes('<') ? 0 : formatCurrencyAmount(feeValue0, 4);
  ...
  var ratioLiquidity = react.useMemo(function () {
    if (positionSDK && poolHook && positionBasic !== null && positionBasic !== void 0 && positionBasic.tokenPre && inverterToken !== null && inverterToken !== void 0 && inverterToken.base) {
      var _inverterToken$base;
      var inverted = positionBasic !== null && positionBasic !== void 0 && positionBasic.tokenSub ? inverterToken === null || inverterToken === void 0 ? void 0 : (_inverterToken$base = inverterToken.base) === null || _inverterToken$base === void 0 ? void 0 : _inverterToken$base.equals(positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tokenSub) : undefined;
      var ratio = getRatio(inverted ? inverterToken === null || inverterToken === void 0 ? void 0 : inverterToken.priceLower : inverterToken === null || inverterToken === void 0 ? void 0 : inverterToken.priceUpper.invert(), poolHook.token0Price, inverted ? inverterToken === null || inverterToken === void 0 ? void 0 : inverterToken.priceUpper : inverterToken === null || inverterToken === void 0 ? void 0 : inverterToken.priceLower.invert());
      return Number(ratio);
    }
    return null;
  }, [inverterToken === null || inverterToken === void 0 ? void 0 : inverterToken.base]);
  var liquidity = react.useMemo(function () {
    if (positionSDK && ratioLiquidity >= 0 && !(positionBasic !== null && positionBasic !== void 0 && positionBasic.isNoData)) {
      var _positionSDK$amount0$, _positionSDK$amount1$;
      var ratioPre = ratioLiquidity;
      var ratioSub = 100 - ratioLiquidity;
      if (Number((_positionSDK$amount0$ = positionSDK === null || positionSDK === void 0 ? void 0 : positionSDK.amount0.toSignificant(4)) != null ? _positionSDK$amount0$ : 0) === 0 && Number((_positionSDK$amount1$ = positionSDK === null || positionSDK === void 0 ? void 0 : positionSDK.amount1.toSignificant(4)) != null ? _positionSDK$amount1$ : 0) === 0) {
        ratioSub = 0;
        ratioPre = 0;
      }
      return {
        liquidityPre: positionSDK === null || positionSDK === void 0 ? void 0 : positionSDK.amount0.toSignificant(4),
        ratioPre: ratioPre,
        liquiditySub: positionSDK === null || positionSDK === void 0 ? void 0 : positionSDK.amount1.toSignificant(4),
        ratioSub: ratioSub
      };
    }
    return null;
  ...
  var inRange = react.useMemo(function () {
    if (positionSDK && poolHook && !(positionBasic !== null && positionBasic !== void 0 && positionBasic.isNoData)) {
      var below = poolHook && Number(poolHook.tickCurrent) < Number(positionSDK === null || positionSDK === void 0 ? void 0 : positionSDK.tickLower);
      var above = poolHook && typeof positionBasic.tickUpper === 'number' ? Number(poolHook.tickCurrent) >= Number(positionSDK === null || positionSDK === void 0 ? void 0 : positionSDK.tickUpper) : undefined;
      var inRanges = !below && !above;
      return inRanges;
    }
    return null;
  }, [positionSDK]);
  var ratioUSDC = useGetRatioUSDC(positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tokenPre, positionBasic === null || positionBasic === void 0 ? void 0 : positionBasic.tokenSub, liquidity, positionSDK);

  react.useEffect(function () {
    if (positionBasic !== null && positionBasic !== void 0 && positionBasic.isNoData && positionBasic) {
      setTimeRadom();
    }
  }, [positionBasic]);
  react.useEffect(function () {
    if (!(positionBasic !== null && positionBasic !== void 0 && positionBasic.isNoData) && positionBasic) {
      if (unClaimFee && ratioLiquidity >= 0 && liquidity && inRange !== null && !isNaN(ratioUSDC === null || ratioUSDC === void 0 ? void 0 : ratioUSDC.liquidityByUSDC) && ratioUSDC !== null && ratioUSDC !== void 0 && ratioUSDC.liquidityByUSDC) {
        var _positionBasic$tokenP, _positionBasic$tokenS;
        var data = {
          ratioLiquidity: ratioLiquidity,
          liquidity: liquidity,
          poolHook: poolHook,
          positionBasic: positionBasic,
          ratioUSDC: ratioUSDC,
          idPool: listPoolOfAddress === null || listPoolOfAddress === void 0 ? void 0 : listPoolOfAddress.listPoolId[indexPool],
          chainId: chainId,
          unClaimFee: unClaimFee,
          inRange: inRange,
          symbolPre: positionBasic === null || positionBasic === void 0 ? void 0 : (_positionBasic$tokenP = positionBasic.tokenPre) === null || _positionBasic$tokenP === void 0 ? void 0 : _positionBasic$tokenP.symbol,
          symbolSub: positionBasic === null || positionBasic === void 0 ? void 0 : (_positionBasic$tokenS = positionBasic.tokenSub) === null || _positionBasic$tokenS === void 0 ? void 0 : _positionBasic$tokenS.symbol
        };
        Promise.all([setListData(function (pre) {
          return [].concat(pre, [data]);
        })]).then(function () {
          setTimeRadom();
        });
      }
    }
  }, [ratioUSDC === null || ratioUSDC === void 0 ? void 0 : ratioUSDC.liquidityByUSDC, unClaimFee]);

  var setTimeRadom = function setTimeRadom() {
    if (indexPool < (listPoolOfAddress === null || listPoolOfAddress === void 0 ? void 0 : listPoolOfAddress.listPoolId.length) - 1) {
      setIndexPool(indexPool + 1);
    } else {
      setIsFinish(true);
    }
    if ((listPoolOfAddress === null || listPoolOfAddress === void 0 ? void 0 : listPoolOfAddress.listPoolId.length) === 0) {
      setIsFinish(true);
    }
  };
  var resetHook = function resetHook() {
    setListData([]);
    setListPoolState([]);
    setIndexPool(0);
    setIsFinish(false);
...
exports.CHAIN_NETWORK_WITH_CHAIN_NAME = CHAIN_NETWORK_WITH_CHAIN_NAME;
...
exports.STABLECOIN_AMOUNT_OUT = STABLECOIN_AMOUNT_OUT;
exports.SupportedChainId = SupportedChainId;
exports.USDC_ARBITRUM = USDC_ARBITRUM;
exports.USDC_ARBITRUM_RINKEBY = USDC_ARBITRUM_RINKEBY;
exports.USDC_GOERLI = USDC_GOERLI;
exports.USDC_KOVAN = USDC_KOVAN;
exports.USDC_MAINNET = USDC_MAINNET;
exports.USDC_OPTIMISM = USDC_OPTIMISM;
exports.USDC_OPTIMISM_GOERLI = USDC_OPTIMISM_GOERLI;
exports.USDC_POLYGON = USDC_POLYGON;
exports.USDC_POLYGON_MUMBAI = USDC_POLYGON_MUMBAI;
exports.USDC_RINKEBY = USDC_RINKEBY;
exports.USDC_ROPSTEN = USDC_ROPSTEN;
exports.USDT = USDT;
exports.V3_CORE_FACTORY_ADDRESSES = V3_CORE_FACTORY_ADDRESSES;
exports.WBTC = WBTC;
exports.WETH9 = WETH9$1;
...
exports.getAddressPool = getAddressPool;
exports.getPositionUniswapAddress = getPositionUniswapAddress;
exports.getRatio = getRatio;
exports.getToken = getToken;
exports.tokens = tokens;
exports.useFullPosition = useFullPosition;
exports.useInverter = useInverter;
exports.usePool = usePool;
exports.usePosition = usePosition;
exports.usePriceOrderingFromPositionForUI = usePriceOrderingFromPositionForUI;
exports.useSlot0 = useSlot0;
