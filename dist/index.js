...
var _function = require('packagePosition/service/function');
      ...
      try {
        var _temp2 = function () {
          if (token0 && token1 && positionBasic && chainId && !isChangeToken) {
            return Promise.resolve(_function.getAddressPool(token0, token1, positionBasic.fee, chainId)).then(function (_getAddressPool) {
